...
export const metadata: Metadata = {
  ...
  title: 'Beep — From Intent to Checkout, Instantly',
  description: 'Tell Beep what you need. Our AI finds, compares, and completes your purchase automatically — flights, shopping, subscriptions.',
  icons: {
    icon: [
